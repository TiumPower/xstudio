# Client Claude (Anthropic) — dùng cho gợi ý nhánh cây định hướng (FR-TREE-20..28).
#
# Đọc ENV["ANTHROPIC_API_KEY"] (dev: .env, prod: shared/.env). Thiếu khoá thì
# service không `configured?` và phần gọi AI báo lỗi tiếng Việt rõ ràng — cây
# không bao giờ bị thay đổi khi AI hỏng (FR-TREE-26).
class ClaudeService
  ...
  def connection
    @connection ||= Faraday.new do |f|
      ...
      f.options.timeout = 20  # mục 9.8 — luôn đặt timeout 20s
